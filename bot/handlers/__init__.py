...
def register_handlers(app: Client):
    ...
    from .controls import pause_command, resume_command, stop_command, skip_command
    from .queue import queue_command
    from .cookie import cookie_command
    ...
    app.add_handler(MessageHandler(skip_command, filters.command("skip") & filters.group))
